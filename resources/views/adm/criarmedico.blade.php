...
<body>
    <div class="container"> 
        ...
        <div class="mb-3">
            <label for="especilidade" class="form-label"><h3>Especialidade(s):</h3></label>
            <input type="text" class="form-control" id="especialidade" name= "especialidade"></div>
        {{-- <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="crm" class="form-label"><h3>CRM:</h3></label>
            <input type="string" class="form-control" id="crm" name= "crm"></div>
        <div class="mb-3">
            <label for="local" class="form-label"><h3>Locais de trabalho:</h3></label>
            <input type="text" class="form-control" id="local" name= "local"></div>

            {{-- //depois colocar o post action// --}}
            <a href="{{route('medicocadastrado')}}" class="btn btn-primary" > <h3>Cadastrar</h3></a>
