...
<body>
    <div class="container">
         <div class="row mt-3">
             <header><div class="d-flex justify-content-center">
                <h1> Informações do Hospital Orlando </h1>
            </div></header>
        </div>

        <div class="row mt-3">
            <div class="d-flex justify-content-center">
               <h3>Horário de funcionamento: 6:30 às 23:00</h3>
           </div>
       </div>
       <div class="row mt-3">
        <div class="d-flex justify-content-center">
           <h3>Médicos: Dr.Rogério, Dra.Fabíola, Dr.Rey</h3>
       </div>
   </div>
        <div class="row mt-3">
            <div class="d-flex justify-content-center">
    ...
    <div class="row mt-3">
       ...
       <h3>Bairro: Centro</h3>
        ...
        <a href="{{route('listarcentrosdesaude')}}" class="btn btn-primary" > <h3>Voltar</h3></a>
    </div>
