    ...
    <div class="container"> 
        <div class="row mt-3">
            <div class="d-flex justify-content-center">
               <h1>Agendar plantão</h1>
           </div>
       </div>
        <form> 
            @csrf
        <div class="mb-3">
          <label for="nome" class="form-label"><h3>Tipo de plantão:</h3></label>
        ...
        <div class="mb-3">
            <label for="horario_inicio" class="form-label"><h3>Horário de início:</h3></label>
            <input type="string" class="form-control" id="horario_termino" name= "horario_inicio"></div>
        <div class="mb-3">
            <label for="horario_termino" class="form-label"><h3>Horário de término</h3></label>
            <input type="string" class="form-control" id="horario_termino" name= "horario_termino"></div>
        <div class="mb-3">
            <label for="nome" class="form-label"><h3>Local:</h3></label>
            <input type="text" class="form-control" id="nome" name= "nome"></div>
            <div class="mb-3">
                <label for="nome" class="form-label"><h3>Médico(a):</h3></label>
                <input type="text" class="form-control" id="nome" name= "nome"></div>


            {{-- //depois colocar o post action// --}}
            <a href="{{route('plantaocadastrado')}}" class="btn btn-primary" > <h3>Cadastrar</h3></a>
